...
#
# Build stage
FROM ghcr.io/astral-sh/uv:python3.14-alpine@sha256:1054a8c47beacaea07c0bbdb073e6b80a26deeb36c270593bb92c75a653d71d5 AS build
WORKDIR /app
...
# Final stage
FROM ghcr.io/astral-sh/uv:python3.14-alpine@sha256:1054a8c47beacaea07c0bbdb073e6b80a26deeb36c270593bb92c75a653d71d5
